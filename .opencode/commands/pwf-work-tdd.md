---
description: "Execute implementation using optional TDD flow (red-green-refactor). Use only when user explicitly requests tests-first behavior."
---
...
<work_tdd_description> $ARGUMENTS </work_tdd_description>
