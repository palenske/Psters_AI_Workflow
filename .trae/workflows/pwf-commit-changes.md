...
**Trae Adaptation**: For each repo with uncommitted changes, read and execute the worker skill instructions directly. You can process multiple repos by reading the skill file once and applying it to each repo.
