...
**Trae Adaptation**: This workflow executes agents by reading their instruction files and applying them directly. Trae does not use the Task tool from Cursor.
...
- `node .trae/scripts/resolve-workflow-extensions.mjs after_plan`
